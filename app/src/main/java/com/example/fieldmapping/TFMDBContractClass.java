...
public class TFMDBContractClass {
    ...
    public static final String TFM_DATABASE_NAME = "fieldmapping.db";
    ...
    public static final String COL_LOAN_FIELD_SIZE                  = "loan_field_size";
    ...
    public static final String SMALL_FM_PICTURE_LOCATION           = "FMPictures/FMPictures_Small";
