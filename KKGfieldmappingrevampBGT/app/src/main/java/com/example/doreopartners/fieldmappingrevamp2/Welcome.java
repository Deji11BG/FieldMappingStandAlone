        ...
        if (permissionGranted()) {
            ...
            if (lm.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                AlertDialog.Builder alertDialogBuilderSuccess = new AlertDialog.Builder(
                        this);
                alertDialogBuilderSuccess.setTitle("Start Mapping");
                // set dialog message
                alertDialogBuilderSuccess
                        .setMessage(
                                "Are you at the boundary of the field?")
                        .setCancelable(false)
                ...
                alertDialogBuilderSuccess.setNegativeButton("No",
                        new DialogInterface.OnClickListener() {
                            public void onClick(

                                    DialogInterface dialog, int id) {
                                Toast.makeText(getApplicationContext(),"Please, move to the boundary of the field",Toast.LENGTH_SHORT).show();
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        this);
                alertDialogBuilder.setTitle("Select Mapping Mode");
                // set dialog message
                alertDialogBuilder

                        .setCancelable(false)
                        .setPositiveButton("Walking",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(
                                            DialogInterface dialog, int id) {
...
//                        memEdit.commit();
//                        paramDialogInterface.dismiss();
//                        AlertDialog.Builder dialog3 = new AlertDialog.Builder(getApplicationContext());
//                                dialog3.setTitle("Start mapping session");
//                                dialog3.setMessage("Are you at the boundary of the field?");
//                                dialog3.setPositiveButton("Yes, start mapping", new DialogInterface.OnClickListener() {
//                                    @Override
...
//                                    public void onClick(DialogInterface dialog, int id) {
//                                        startActivity(new Intent(Welcome.this, Welcome.class));
//                                        Toast.makeText(getApplicationContext(),"Please, move to the boundary of the field",Toast.LENGTH_SHORT);
//
//                                    }
//                                });
//                                dialog3.show();
