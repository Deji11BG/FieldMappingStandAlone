        ...
        builder.setTitle("Give the field a description to remember where it is.")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        dami_description = etArea.getText().toString();
                        memEdit.commit();
                    }
                });
...
//                                            intent.setComponent(new ComponentName("com.babbangona.tglapp","com.babbangona.tglapp.startmapping"));
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    e.printStackTrace();
                                                    Log.d("fieldMapping", e.toString());
                                                    Toast.makeText(MappingForm.this, "Clearance application missing in your phone. Contact Supervisor", Toast.LENGTH_LONG).show();
                                                }
